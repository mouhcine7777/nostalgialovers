...
const artistData = {
  "3 Juillet": [
    ...
    { "name": "THOMAS ANDRES FROM MODERN TALKING", "image": "3juillet/thomasAnders.webp", "youtubeId": "eNvUS-6PTbs", "genre": "Pop", "era": "80s", "description": "Voix mythique de Modern Talking, célèbre pour Cheri Cheri Lady.", "additionalInfo": "Cheri Cheri Lady – Un hit eurodance culte des années 80." },
  ...
  "4 Juillet": [
    ...
    { "name": "LA CASSETTE DJ’S", "image": "4juillet/lacassette.webp", "youtubeId": "kgm91oouvlE", "genre": "EDM", "era": "2010s", "description": "DJ talentueux mixant les plus grands classiques des années 80 et 90 avec une touche moderne.", "additionalInfo": "Spécialiste des remix énergiques qui font vibrer les pistes de danse." },
  ...
  "5 Juillet": [
    { "name": "DAISY DEE TECHNOTRONIQUE", "image": "5juillet/technotronique.webp", "youtubeId": "9EcjWd-O4jI", "genre": "Techno", "era": "90s",  "description": "Pionnier de l’eurodance avec le tube Pump Up the Jam.","additionalInfo": "Pump Up the Jam : Eurodance iconique, un incontournable des clubs." },
    ...
    { "name": "SALOMÉ DE BAHIA", "image": "5juillet/salomedebahia.webp", "youtubeId": "eCvCnCMmXRI", "genre": "Brazilian Jazz", "era": "2000s", "description": "Artiste brésilienne alliant samba et sons modernes, avec des hits comme Outro Lugar.", "additionalInfo": "Outro Lugar : Samba moderne et festive, un mélange vibrant de rythmes brésiliens." },
    { "name": "MAD STUNTMAN AKA REEL 2 REAL", "image": "5juillet/reel2reel.webp", "youtubeId": "vuo8kD5zF5I", "genre": "Dance", "era": "90s", "description": "Groupe eurodance des années 90, avec le célèbre I Like to Move It.",  "additionalInfo": "I Like to Move It : Eurodance explosif, avec un refrain irrésistible." },
