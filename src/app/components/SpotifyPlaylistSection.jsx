      ...
      <div className="relative container mx-auto px-4 grid md:grid-cols-2 gap-12 md:gap-20 items-center">
        ...
        >
          ...
          <p className="text-base md:text-lg font-[Montserrat] font-light leading-relaxed text-gray-600">
            En attendant la prochaine édition du Nostalgia Lovers Festival 2025, 
            découvrez l'univers musical qui vous attend avec notre playlist officielle. 
            Ces morceaux légendaires vous donneront un avant-goût de l'expérience unique 
            que nous préparons. Écoutez, partagez et rejoignez-nous pour célébrer ensemble 
            la nostalgie musicale !
          </p>
